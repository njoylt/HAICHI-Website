...
const campaignAttribution = {
  ...
  campaign: attributionValue(pageParams.get('utm_campaign'), 'haichi_site_v1_3_personal'),
...
document.querySelectorAll('a[href^="https://haichi.lemonsqueezy.com/checkout/"]').forEach(link => {
  ...
  checkoutUrl.searchParams.set('checkout[custom][landing_version]', 'v1_3_personal_release');
