...
Status: manual tracking only; no automated outreach has been sent.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 |  |  | Ollama/dev user | No |  |  |  |  |  |  |
| 2 |  |  | solo developer | No |  |  |  |  |  |  |
| 3 |  |  | indie hacker | No |  |  |  |  |  |  |
| 4 |  |  | local AI power user | No |  |  |  |  |  |  |
| 5 |  |  | coding-agent user | No |  |  |  |  |  |  |
| 6 |  |  | Ollama/dev user | No |  |  |  |  |  |  |
| 7 |  |  | solo developer | No |  |  |  |  |  |  |
| 8 |  |  | indie hacker | No |  |  |  |  |  |  |
| 9 |  |  | local AI power user | No |  |  |  |  |  |  |
| 10 |  |  | coding-agent user | No |  |  |  |  |  |  |

## Manual message to send first
...
- Where did they stop?
- If they want Pro, do they need the `€29` founder code?
